...
python predict_paper.py checkpoints/unet_paper/model030000.pt data/Dataset_segmentation/Split3/VAL/IMG data/Results/Split3/VAL/IMG_GEN $MODEL_FLAGS $TRAIN_FLAGS
