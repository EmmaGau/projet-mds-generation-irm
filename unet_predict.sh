...
#python predict.py heckpoints/finetune/segm200_64_split3.pth data/Dataset_segmentation/Split/VAL/IMG data/Results/Split/VAL/ $MODEL_FLAGS $TRAIN_FLAGS --lr 1e-4 --image_size 256  --out_channels 7 --batch_size 2
